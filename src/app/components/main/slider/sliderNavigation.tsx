...
import { IChangeCurrentSlide, ISliderNavigation } from "./types/slider.d";
...
export const changeCurrentSlide: IChangeCurrentSlide = (
  i,
  setCurrent,
  setIsTouched,
) => {
...
const NavigationDots: React.FC<ISliderNavigation> = ({
  current,
  setCurrent,
  setIsTouched,
}) => {
      ...
      {dots.map((dot, i) => {
        ...
        return (
          <div
            ...
            onClick={() => changeCurrentSlide(i, setCurrent, setIsTouched)}
            style={isCurrent ? ActiveDotStyle : DotStyle}
          />
        );
      })}
    </Stack>
